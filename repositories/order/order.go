...
func (repo *OrderRepository) Create(newOrder O.Orders) (ResponseOrder, error) {
	...
	repo.db.Table("orders as o").
		Select("o.id as ID, o.user_id as UserID, o.service_id as ServiceID, s.title as ServiceTitle, s.price as Price, o.qty as Qty, o.date as Date, o.address as Address, o.city as City, o.phone as Phone, o.status as Status, o.is_paid as IsPaid, o.url as Url").
...
func (repo *OrderRepository) Get() ([]ResponseOrder, error) {
	...
	if rowsAffected := repo.db.Table("orders as o").Select("o.id as ID, o.user_id as UserID, o.service_id as ServiceID, s.title as ServiceTitle, s.price as Price, o.qty as Qty, o.date as Date, o.address as Address, o.city as City, o.phone as Phone, o.status as Status, o.is_paid as IsPaid, o.url as Url").Joins("inner join services as s on s.id = o.service_id").Joins("inner join payment_methods as pm on pm.id = o.payment_method_id").Find(&orders).RowsAffected; rowsAffected == 0 {
...
func (repo *OrderRepository) GetByUserID(UserID uint) ([]ResponseOrder, error) {
	...
	if rowsAffected := repo.db.Table("orders as o").Select("o.id as ID, o.user_id as UserID, o.service_id as ServiceID, s.title as ServiceTitle, s.price as Price, o.qty as Qty, o.date as Date, o.address as Address, o.city as City, o.phone as Phone, o.status as Status, o.is_paid as IsPaid, o.url as Url").Joins("inner join services as s on s.id = o.service_id").Joins("inner join payment_methods as pm on pm.id = o.payment_method_id").Where("o.user_id = ?", UserID).Find(&orders).RowsAffected; rowsAffected == 0 {
		return nil, errors.New("tidak terdapat order sama sekali")
	}
	return orders, nil
}
...
func (repo *OrderRepository) GetByID(ID uint) (ResponseOrder, error) {
	...
	if rowsAffected := repo.db.Table("orders as o").Select("o.id as ID, o.user_id as UserID, o.service_id as ServiceID, s.title as ServiceTitle, s.price as Price, o.qty as Qty, o.date as Date, o.address as Address, o.city as City, o.phone as Phone, o.status as Status, o.is_paid as IsPaid, o.url as Url").Joins("inner join services as s on s.id = o.service_id").Joins("inner join payment_methods as pm on pm.id = o.payment_method_id").Where("o.id = ?", ID).First(&order).RowsAffected; rowsAffected == 0 {
...
func (repo *OrderRepository) InsertUrl(ID uint, url string) (ResponseOrder, error) {
	...
	repo.db.Table("orders as o").Select("o.id as ID, o.user_id as UserID, o.service_id as ServiceID, s.title as ServiceTitle, s.price as Price, o.qty as Qty, o.date as Date, o.address as Address, o.city as City, o.phone as Phone, o.status as Status, o.is_paid as IsPaid, o.url as Url").
		Joins("inner join services as s on s.id = o.service_id").
		Joins("inner join payment_methods as pm on pm.id = o.payment_method_id").
